...
namespace Drupal\Tests\osu\Functional;
...
/**
 * Tests Osu installation profile expectations.
 *
 * @group osu
 */
class OsuTest extends BrowserTestBase {

  use SchemaCheckTestTrait;

  protected $profile = 'osu';
  ...
  /**
   * Tests Osu installation profile.
   */
  function testOsu() {
    $this->drupalGet('');
    ...
    // osu profile modules are enabled.
    ...
    // Ensure that configuration from the Osu profile is not reused when
